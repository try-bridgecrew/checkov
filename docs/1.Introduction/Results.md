...
All done with the introductions. Next, we suggest exploring some more advanced topics like: [Suppressions](../2.Concepts/Suppressions.md) and [Custom Scans](../2.Concepts/custom-scans.md). After that, conclude with  
